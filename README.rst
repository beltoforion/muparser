...
Bugfixes:
-----------
* Compiler Warnings disabled (Visual Studio): Disabled compiler warning 26812 (Prefer 'enum class' over 'enum') Use of plain old enums has not been deprecated and only MSVC is complaining. 
